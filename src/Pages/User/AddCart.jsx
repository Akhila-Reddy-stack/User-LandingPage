            ...
            <div>
              <Row>
                <Col md={7} className="cart-details">
                    ...
                    <div className="addorder-details-list addbookoSum">
                      <div>
                        ...
                        <span class="addlisted">
                          ...
                          <br />
                          <span class="cartlisted"> Size:No Size</span>
                          <br />
                          <span class="cartlisted qty">Qty:{item.Instock}</span>
                          <span class="cartlisted qty pr">
                      ...
                      <div>
                        <Row>
                          <div className="row mb-3 px-2 status ">
                            ...
                            <span className="mar">${item.Pricewithtax}.00</span>
                  ...
                  {/* <div className="row mb-3 px-2 item-details multiplecart">
                    <div>
                      <Row>
                        ...
                        <Col md={10} className="item">
                          ...
                          <div className="rating">
                            <Row className="rating-div">
                              ...
                              <Col md={6}>Size: {size1}</Col>
                            </Row>
                            <div className="">
                              Qty
                              <Button
                                className="minusbtn"
                                onClick={() => this.minusbtn(1)}
                              >
                                -
                              </Button>
                        ...
                        <Col md={10} className="item">
                          ...
                          <div className="rating">
                            <Row className="rating-div">
                              ...
                              <Col md={6}>Size: {size2}</Col>
                            </Row>
                            <div className="">
                              Qty
                              <Button
                                className="minusbtn"
                                onClick={() => this.minusbtn(2)}
                              >
                                -
                              </Button>
                        ...
                        <Col md={10} className="item">
                          ...
                          <div className="rating">
                            <Row className="rating-div">
                              ...
                              <Col md={6}>Size: {size3}</Col>
                            </Row>
                            <div className="">
                              Qty
                              <Button
                                className="minusbtn"
                                onClick={() => this.minusbtn(3)}
                              >
                                -
                              </Button>
                ...
                <Col md={5} className="summary">
                  <div>
                    <div class="vocher">
                      ...
                      APPLY VOCHER CODE{" "}
                      <i class="fas fa-arrow-circle-right nexticon"></i>
                    </div>
                    <div class="order">
                    ...
                    <Row className="save">You Save $5.00 in this order</Row>
                  </div>
                  <div>
                    <Row>
